		...
		<>
			...
			<div className='grid grid-cols-5 gap-4 my-5 w-max-1250 m-auto'>
				<div className='col-span-1'>
					...
					<BaseRange label='Giá bán' min={10000} max={100000} unit={'VND'} />
				...
				<div className='pl-7 col-span-4'>
					...
					<section className='grid grid-cols-3 gap-5 my-2 pt-5'>
						<ListProduct list={productList.data} />
					</section>
					{productList.meta?.lastPage > 0 && (
						<div className='flex justify-end mt-4'>
							<BasePagination link={'/product'} search={newSearchParams} />
						</div>
					) }
				</div>
			</div>
